...
### Input
goal:
完成C:\Users\123\Desktop\neizu\tasknew里面的任务要求
task_directory:
C:\Users\123\Desktop\neizu\tasknew
hardware_config:
{'build_command': 'cmake --build build', 'flash_command': 'pyocd flash -t stm32f103c8 build/firmware.elf', 'serial_port': 'COM3', 'project_root': 'C:\\Users\\123\\Desktop\\neizu\\tasknew', 'serial_baudrate': 115200, 'serial_timeout_sec': 30, 'build_timeout_sec': 120, 'flash_timeout_sec': 120, 'host_test_command': 'python host_tests/smoke_test.py --port COM7 --baud 115200', 'host_test_timeout_sec': 120, 'max_attempts': 10}
...
### Source Materials
(List the important directories and files you inspected. Keep it compact.)
